...
# Configurazione del database (usa un database reale, ad esempio PostgreSQL, nel tuo ambiente di produzione)
...
def register():
        ...
        if form.validate_on_submit():
            ...
            # Invio dell'email di conferma con template HTML
            msg = Message('Nuovo Utente Aggiunto', sender='your_email@example.com', recipients=['adminsito@gmail.com'])
            msg.html = render_template('confirmation_email.html', token=token)
            mail.send(msg)
